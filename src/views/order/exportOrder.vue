<template>
  <div class="exportorder_content">
      ...
      <div style="margin-bottom: 5px;">
        <el-row style="padding-left: 2%;">
          ...
          <el-col :span="3" style=" margin-top: 2px;">
            <p sort="title" class="title">出口订单</p>
          </el-col>
        </el-row>
      </div>
      <div class="form">
        ...
        >
          ...
          <el-row>
            <el-col :span="10">
              <el-form-item label="终端客户：" prop="endCustomerId">
                <el-select
                  v-model="order.endCustomerId"
                  filterable
                  placeholder="请选择终端客户"
                  default-first-option
                >
                  <el-option
                    v-for="(item,index) in endCustomerLists"
                    :key="index"
                    :label="item.clientNameCn"
                    :value="item.id"
                  ></el-option>
                </el-select>
              </el-form-item>
            ...
            <el-col :span="1"></el-col>
            <el-col :span="3">
              <el-button type="primary" class="el-icon-plus" @click="handleCreate">添加终端客户</el-button>
            </el-col>
          </el-row>
    ...
    <CreateCustomer
      :dialogCusex="dialogCusex"
      :customerFormex="customerFormex"
      @update="getCustomer"
    ></CreateCustomer>
  </div>
</template>
  ...
  methods: {
    ...
    getCustomer() {
      ...
      getEndCustomer({
        ...
        this.endCustomerLists = response.result.items;
      });
    },
    // 增加一行
    addRow() {
